...
public struct Plan: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        releaseRuntimePackageProduct: String = "HelixAppIntegration",
        developmentRuntimePackageProduct: String = "HelixDevSupport",
    ...
    public func validate() throws {
        guard schemaVersion == Self.currentSchemaVersion,
              ...
              releaseRuntimePackageProduct == "HelixAppIntegration",
              developmentRuntimePackageProduct == "HelixDevSupport",
