...
public enum ShellBuild {
    ...
    public static let transformPipelineHash = Core.Digest.sha256(
        "Helix.ShellBuild.DynamicSourceTransform.v1:declaration-groups:frozen-value-hooks:source-body-dispatch:async-original-thunks:native-call-descriptor-v1:objective-c-invoker:objective-c-lightweight-generic-erasure:c-invoker-main-actor-unqualified-reference:swift-adapter-pack-v1:development-native-candidate-emission:production-native-capability-manifest:indexed-source-baseline-metadata:objective-c-declaration-qualified-sil:property-declaration-identity:exact-module-imports:separate-hub-contract-object:module-native-api-catalog:bounded-parallel-native-probes:published-catalog-projection:catalog-authoritative-descriptor:catalog-source-projections:complete-catalog-probe-publication:measured-native-type-isolation:storable-and-inhabited-native-boundaries:managed-inout-boundary-filter:compiler-measured-callback-lifetimes:signature-module-imports:render-all-signature-imports:concrete-invalid-owner-recovery:synthesized-objective-c-initializers:objective-c-protocol-anyobject-surface:swift-overlay-extension-module-ownership:inherited-main-actor-symbol-graph-closure:compiler-inferred-main-actor-probes:line-bound-main-actor-diagnostics:compiler-wide-deprecation-filter:pre-catalog-source-alias-normalization:exact-alias-identity-fixed-point:compiler-proven-initializer-nominal-aliases:pure-swift-reference-alias-identity:canonical-declaration-owner-aliases:module-global-operation-aliases:catalog-comparison-aliases:catalog-authoritative-alias-supersets:catalog-enum-kind-and-value-refinement:opaque-native-enum-typeops:swift-any-objective-c-bridge:foundation-collection-foreign-representation:catalog-exact-declaration-matching:declaration-missing-objective-c-implementation-lookup:large-module-interop-replay:usr-source-nominals:file-scoped-nominal-v2:ambiguous-private-layouts:literal-search-paths:qualified-device-autostart:abi-group-qualified-imported-spellings:definition-backed-sil-debug-identity:scoped-conformance-inventory:extension-access-defaults:compiler-symbol-roles:clang-runtime-spellings:independent-sil-inspection:scoped-frontend-diagnosis:structured-sil-entity-wrappers:proven-location-fallbacks:declaration-scoped-mapping-exclusions:host-plan-indexing-v2:exact-clang-nominals:c-member-argument-projection-v2:target-os-imports:clang-typedef-layout-evidence:related-decl-filter:unique-probe-aliases"
    )
}
