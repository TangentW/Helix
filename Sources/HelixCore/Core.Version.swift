...
public enum Versions {
    public static let runtime = Core.SemanticVersion(1, 0, 0)
    public static let bytecode = Core.SemanticVersion(1, 0, 0)
    public static let interfaceArchive = Core.SemanticVersion(1, 0, 0)
