...
上文的 witness 分派限制指运行时、条件式、开放式、歧义或 mutable-existential 派发；完全具体的 call 与不可变闭合 existential call 都会由 Compiler 提前解析为 image call，不携带 Swift witness table，也不改变 1/1.0 合同。
